...
import com.example.covidtracker.api.Connectivity
import com.example.covidtracker.api.CovidApi
import com.example.covidtracker.api.PrettyPrintLogger
import com.example.covidtracker.utils.Contracts.Companion.BASE_URL
...
object ApiModule {
    ...
    @Provides
    @Singleton
    fun provideMovieApi(retrofit: Retrofit): CovidApi =
